...
class CalDAVComplianceMixIn(object):
    ...
    def davComplianceClasses(self):
        ...
        """
        return tuple(super(CalDAVComplianceMixIn, self).davComplianceClasses()) + carddavxml.carddav_compliance
...
class CalendarPrincipalResource (CalDAVComplianceMixIn, DAVPrincipalResource):
    ...
    def readProperty(self, property, request):
        ...
        """
        if config.EnableCardDAV and namespace == carddav_namespace:

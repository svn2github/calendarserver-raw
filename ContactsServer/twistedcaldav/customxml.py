...
class ResourceID (davxml.WebDAVTextElement):
    """
    resource id, same as UUID
    http://tools.ietf.org/html/draft-ietf-webdav-bind-23#section-3.1
    FIXME:  This should be part of Twisted
    """

...
if sys.platform == "darwin":
    extensions.append(
        Extension(
            "addressbookserver.platform.darwin._sacl",
            extra_link_args = ["-framework", "Security"],
            sources = ["addressbookserver/platform/darwin/_sacl.c"]
        )
    )
...
dist = setup(
    ...
    scripts          = [ "bin/carddavd", ],
    data_files       = [ ("carddavd", ["conf/carddavd.plist.default" ]) ],
